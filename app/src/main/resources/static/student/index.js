...
function getStudent(e) {
  ...
  fetch("../students/" + no)
    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector("#f-photo-origin").href = `https://kr.object.ncloudstorage.com/bitcamp-bucket-57-member-photo/${student.photo}`;
        document.querySelector("#f-photo").src = `http://nmxqkrdkuimj16872585.cdn.ntruss.com/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } /*else {
